function idSearch(){
    var element=document.getElementById('searchId').value
    var myTab = document.getElementById('studentTable');
    console.log(myTab.rows.length);
    var i=1;
    while(myTab.rows.length!=2){
        var objCells=myTab.rows.item(i).cells;
        if(objCells.item(0).innerHTML!=element)
...
function addStudent() {
    ...
    idCell.innerHTML ='<p style=color:green>' +item.studentId+'</p>';
