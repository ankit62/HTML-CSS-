...
function displayCart() {
    ...
    cart.forEach(i => {
        ...
        Minus.innerHTML =
            "<button class='btn btn-minus btn-secondary float-right' onclick = 'minus(" +
            i.id +
            ")'>-</button>";
        Count.innerHTML =
        ...
        Plus.innerHTML =
            "<button class='btn btn-plus btn-secondary float-left' onclick = 'plus(" +
            i.id +
            ")'>+</button>";
